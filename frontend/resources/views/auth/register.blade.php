...
<div class="auth-form-wrapper">
    <div class="auth-form-header">
        ...
        <p>Créez votre accès pour utiliser le chat administratif et retrouver vos échanges.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="auth-form">
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Nom et prénom">
            </div>
        </div>
